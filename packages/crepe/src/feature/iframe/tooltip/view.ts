...
import { iframeId, type IframeConfig } from '..'

import { IframeTooltip } from './component'

export class IframeInlineTooltip implements PluginView {
  #content: HTMLElement
  ...
  constructor(
    ...
    this.#app = createApp(IframeTooltip, {
      config,
  ...
  #shouldShow = (view: EditorView) => {
    const shouldShow = () => {
      ...
      if (node.type.name !== iframeId) return false
